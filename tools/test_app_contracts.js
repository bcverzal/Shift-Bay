...
function run() {
  ...
  includes(app, 'NORMALIZED_SCHEDULE_MODE !== "legacy"', "the ordinary scheduler must use normalized schedule reads unless the compatibility rollback is explicitly requested");
