...
assert.match(edge, /function normalizedCollectionFallback\(/);
assert.match(edge, /normalizedFallbackCollections\.includes\("unassignedShifts"\)/);
assert.match(edge, /unassignedShifts: normalizedFallbackCollections\.includes\("unassignedShifts"\) \? snapshotOpenShifts/);
